...
export type NotificationCategory = 'transactional' | 'operational' | 'digest' | 'alert' | 'marketing';
export type NotificationStatus = 'pending' | 'processing' | 'delivered' | 'partial' | 'failed' | 'suppressed' | 'expired';
export type NotificationActorType = 'user' | 'system' | 'api_key' | 'agent' | 'workflow';
export type NotificationChannelType = 'email' | 'push' | 'sms' | 'in_app' | 'slack' | 'teams' | 'webhook';
export type NotificationDeliveryStatus = 'pending' | 'queued' | 'sent' | 'delivered' | 'failed' | 'suppressed' | 'bounced';
