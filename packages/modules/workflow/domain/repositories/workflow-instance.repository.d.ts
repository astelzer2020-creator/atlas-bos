...
export type WorkflowInstanceStatus = 'running' | 'waiting' | 'completed' | 'failed' | 'cancelled' | 'compensating' | 'suspended';
...
//# sourceMappingURL=workflow-instance.repository.d.ts.map